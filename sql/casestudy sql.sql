...
-- Nhập dữ liệu vào bảng lọa khách
...
-- Nhập dữ liệu vào bảng dich_vu_di_kem
...
-- Nhập dữ liệu vào bảng hop_dong
...
-- Nhập dữ liệu vào bảng hop_dong_chi_tiet
